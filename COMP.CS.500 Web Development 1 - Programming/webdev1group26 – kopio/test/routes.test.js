...
describe('Routes', () => {
  ...
  describe('handleRequest()', () => {
    ...
    describe('Updating products: PUT /api/products/{id}', () => {
      ...
      it('should allow partial update of product properties (name + price)', async () => {
      ...
      it('should allow partial update of product properties (image + description)', async () => {
        const productWithPartialData = { ...product };
        delete productWithPartialData.name;
        delete productWithPartialData.price;
        ...
        expect(response.body.price).to.equal(testProduct.price);
      });
