...
class Graph {
    ...
    */
    ...
    public static class Edge implements Comparable {
		...
		public Node     vertex1;    /* nodes attached to            */
		public Node     vertex2;
		public int     marker;     /* marker for use in algorithms */

		public Edge (Node vertex1, Node vertex2, double weight) {
		...
		*/
                ...
                /*		public int otherEnd (Node thisEnd) {
		...
		*/
		public int compareTo (Object other) {
		    ...
		    */
		    ...
		    return (int) (weight - ((Edge)other).weight);
		}
    }
    ...
    public static class Vertex {
		...
		public double    ufWeight; /* weight in UNION-FIND _when root of tree_ */
    ...
    */
    ...
    public boolean hasEdgeFromTo (Node from, Node to) {
    ...
    /* recursive part */
    private void depthFirstSearchRec (Node v) {
    ...
    /* 
       ...
       using a Queue.
    */
    public void breadthFirstSearch (Node v) {
