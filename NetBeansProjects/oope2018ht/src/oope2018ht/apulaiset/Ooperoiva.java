...
public interface Ooperoiva<T> {
   ...
   /** Tutkii onko listalla haettavaa oliota equals-mielessä vastaava alkio.     
     ...
     * vastaavia alkioita. Operaatio ei muuta listan sisältää millään tavalla.
     *
     ...
     * @return viite löäydettyyn alkioon. Paluuarvo on null, jos parametri on
   ...
   /** Listan alkioiden välille muodostuu kasvava suuruusjärjestys, jos lisäys
     ...
     * annotaation käytästä on annettu harjoitustehtävän 7.3. mallivastauksessa.
     *
