...
private:
    ...
    const int ROWS = 5; // give your own value here
    // Number of horizontal cells (places for fruits)
    const int COLUMNS = 5; // give your own value here
    ...
    std::vector<std::vector<QGraphicsRectItem*>> fruit_grid;
    std::vector<QGraphicsRectItem*> fruit_row;
